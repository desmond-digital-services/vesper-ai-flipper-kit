...
- **Field work:** Site observations, material calculations, standards lookups, voice-to-text logging
...
- Attempt to bypass security controls, authentication, or authorization on any system
- Use the device or its AI capabilities to assist in unauthorized access of any kind
- Use it as part of any activity intended to gain unauthorized access to physical or digital property

### 2.2 — Harm, Harassment, and Illicit Activity
- Generate content intended to harm, threaten, harass, or intimidate any person or group
- Assist in planning or executing illegal acts of any kind
- Generate malware, exploit code, or instructions for causing harm
- Create content that exploits minors in any way

### 2.3 — Surveillance and Invasion of Privacy
- Use the device to conduct surveillance on individuals without their knowledge and consent where legally required
- Record conversations or capture data in ways that violate applicable wiretapping or recording laws in your jurisdiction
- Use captured data to stalk, track, or monitor individuals without legitimate business justification

### 2.4 — Impersonation and Fraud
- Use the device to impersonate a person or organization in a deceptive or harmful way
- Generate fake documents, credentials, or communications intended to defraud
- Use it to assist in phishing, social engineering, or similar attacks

### 2.5 — Circumvention of Safety Controls
- Use the device to bypass, override, or interfere with safety systems on any equipment, vehicle, or infrastructure
- Use AI-generated instructions to circumvent protective measures in agricultural, industrial, or manufacturing settings in ways that create physical safety risks

### 2.6 — Modification of the Device
- Modify the firmware or software in ways that disable safety features or enable prohibited uses
- Use modified firmware to circumvent this policy

---

## 3. Respecting Privacy and Property

### 3.1 — Privacy of Others
...
### 3.3 — Property Rights
Do not use the kit or its AI features to assist in infringing on the intellectual property, copyrights, trademarks, or trade secrets of others.
...
- Not take legal action against good-faith security researchers who follow this policy
- Credit reporters in any fix we release (unless you prefer anonymity)

### 4.2 — What We Ask of You

Do not:
- Exploit vulnerabilities for any purpose beyond verifying they exist
- Share findings publicly before giving us time to fix them (we ask for 30 days)
- Access, modify, or delete data that isn't yours
- Disrupt the service or degrade performance for other users
...
- Any use where inaccurate information could cause harm

AI can make mistakes. It can produce plausible-sounding but incorrect information. Use your judgment. When in doubt, verify with a qualified professional.
...
We make these decisions at our discretion, based on the severity and context of the violation.

### 7.2 — How We Monitor

We do not continuously monitor what customers do with their kits. However:
- We may investigate reports of misuse received through our support channels
- We may review activity that triggers automated abuse detection systems
- We cooperate with valid legal requests from law enforcement
